...
define('REDIRECT_URI', 'http://localhost/Kanpokohack/project-root/backend/phpFinal/callback.php'); // URL de redirección después del login
define('REDIRECT_URI_LOGOUT', 'http://localhost/Kanpokohack/project-root/backend/phpFinal/');
?>