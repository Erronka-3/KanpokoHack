...
function getAdminToken() {
    ...
    curl_setopt($ch, CURLOPT_SSLKEY, 'C:\xampp\htdocs\RETO3_GRUPO\kanpokohack\project-root\config\tls\key.pem'); // Clave privada del cliente
    curl_setopt($ch, CURLOPT_CAINFO, 'C:\xampp\htdocs\RETO3_GRUPO\kanpokohack\project-root\config\tls\cacert.pem');
